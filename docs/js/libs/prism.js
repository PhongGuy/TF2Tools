...
const Prism = (function (u) {
          ...
          for (const o in r) {
            if (r.hasOwnProperty(o) && r[o]) {
              ...
              for (let u = 0; u < s.length; ++u) {
                ...
                for (
                  let v = c.pattern || c, m = a.next, y = i;
                  ...
                  if (!(b instanceof W)) {
                    ...
                    const S = k[0];
                    const O = b.slice(0, w);
                    const L = b.slice(w + S.length);
                    const N = y + b.length;
                    l && N > l.reach && (l.reach = N);
                    let j = m.prev;
                    O && ((j = I(t, j, O)), (y += O.length)), q(t, j, x);
                    const C = new W(o, g ? M.tokenize(S, g) : S, d, S);
                    if (((m = I(t, j, C)), L && I(t, m, L), x > 1)) {
                      const _ = { cause: o + "," + u, reach: N };
                      e(n, t, r, m.prev, y, _),
  ...
  const t = M.util.currentScript();
  function r() {
    M.manual || M.highlightAll();
  }
  if (
    (t &&
      ((M.filename = t.src), t.hasAttribute("data-manual") && (M.manual = !0)),
    !M.manual)
  ) {
    const a = document.readyState;
    a === "loading" || (a === "interactive" && t && t.defer)
...
!(function (s) {
  ...
  const i = "class enum interface struct";
  const r =
  ...
  const f = a("<<0>>(?:\\s*<<1>>)?", [h, g]);
  const m = a("(?!<<0>>)<<1>>(?:\\s*\\.\\s*<<1>>)*", [c, f]);
  const k = "\\[\\s*(?:,\\s*)*\\]";
  const y = a("<<0>>(?:\\s*(?:\\?\\s*)?<<1>>)*(?:\\s*\\?)?", [m, k]);
  const w = a("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?", [
    a("\\(<<0>>+(?:,<<0>>+)+\\)", [
      a("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [g, b, k]),
    ]),
    m,
...
!(function (e) {
  ...
  const o = { pattern: RegExp(n), greedy: !0 };
          ...
          !(function e(n) {
            for (let t = 0; t < n.length && !(m >= d.length); t++) {
              ...
              if (
                ...
                const c = typeof a === "string" ? a : a.content;
                const i = v(k, r);
                const u = c.indexOf(i);
                if (u > -1) {
                  ++m;
...
!(function (u) {
  ...
  (u.languages.markdown = u.languages.extend("markup", {})),
    ...
    u.hooks.add("after-tokenize", function (n) {
      (n.language !== "markdown" && n.language !== "md") ||
        !(function n(e) {
    ...
    u.hooks.add("wrap", function (n) {
      if (n.type === "code-block") {
        for (var e = "", t = 0, a = n.classes.length; t < a; t++) {
          const i = n.classes[t];
          const r = /language-(.+)/.exec(i);
          if (r) {
            e = r[1];
            break;
          }
        }
        const o = u.languages[e];
        if (o) {
          const l = document.createElement("div");
          l.innerHTML = n.content;
          const s = l.textContent;
          n.content = u.highlight(s, o, e);
        } else if (e && e !== "none" && u.plugins.autoloader) {
          const d =
            "md-" +
            new Date().valueOf() +
            "-" +
...
!(function (e) {
  const i = (Prism.languages.powershell = {
    comment: [
      { pattern: /(^|[^`])<#[\s\S]*?#>/, lookbehind: !0 },
...
!(function () {
  if (
    ...
    Prism.hooks.add("before-sanity-check", function (e) {
      ...
      Prism.hooks.add("complete", function e(t) {
        const n = t.element.parentElement;
        if (c(n)) {
          clearTimeout(u);
          const i = Prism.plugins.lineNumbers;
          const r = t.plugins && t.plugins.lineNumbers;
  ...
  function d(u, e, c) {
    const t = (e =
      typeof e === "string" ? e : u.getAttribute("data-line") || "")
      .replace(/\s+/g, "")
      .split(",")
      .filter(Boolean);
    const d = +u.getAttribute("data-line-offset") || 0;
    const f = (a() ? parseInt : parseFloat)(getComputedStyle(u).lineHeight);
    const p = Prism.util.isActive(u, o);
    const n = u.querySelector("code");
    const h = p ? u : n || u;
    const m = [];
    const g =
      n && h != n
    ...
    t.forEach(function (e) {
      ...
      if (
        ...
        const o = Prism.plugins.lineNumbers.getLine(u, n);
        const s = Prism.plugins.lineNumbers.getLine(u, i);
        if (o) {
          const a = o.offsetTop + g + "px";
          m.push(function () {
            r.style.top = a;
          });
        }
        if (s) {
          const l = s.offsetTop - o.offsetTop + s.offsetHeight + "px";
          m.push(function () {
            r.style.height = l;
          });
        }
    ...
    if (p && Prism.util.isActive(u, s) && i) {
      ...
      const r = parseInt(u.getAttribute("data-start") || "1");
...
!(function () {
  if (typeof Prism !== "undefined" && typeof document !== "undefined") {
    const o = "line-numbers";
    var a = /\n(?!$)/g;
    const e = (Prism.plugins.lineNumbers = {
      getLine: function (e, n) {
        if (e.tagName === "PRE" && e.classList.contains(o)) {
          const t = e.querySelector(".line-numbers-rows");
          if (t) {
            const i = parseInt(e.getAttribute("data-start"), 10) || 1;
            const r = i + (t.children.length - 1);
            n < i && (n = i), r < n && (n = r);
            const s = n - i;
            return t.children[s];
          }
      ...
      Prism.hooks.add("complete", function (e) {
        if (e.code) {
          ...
          if (
            ...
            let i;
            const r = e.code.match(a);
            const s = r ? r.length + 1 : 1;
            const l = new Array(s + 1).join("<span></span>");
    ...
    if (
      ...
      const n = e
        .map(function (e) {
          ...
          const t = e.querySelector(".line-numbers-rows");
          if (n && t) {
            let i = e.querySelector(".line-numbers-sizer");
            const r = n.textContent.split(a);
            i ||
      ...
      n.forEach(function (e) {
        const i = e.sizer;
        const n = e.lines;
        const r = e.lineHeights;
        const s = e.oneLinerHeight;
        (r[n.length - 1] = void 0),
          n.forEach(function (e, n) {
            if (e && e.length > 1) {
              const t = i.appendChild(document.createElement("span"));
...
!(function () {
  if (typeof Prism !== "undefined" && typeof document !== "undefined") {
    ...
    const e = (Prism.plugins.toolbar.registerButton = function (e, n) {
      let t;
      (t =
        typeof n === "function"
          ? n
    ...
    const t = (Prism.plugins.toolbar.hook = function (a) {
      const e = a.element.parentNode;
      if (
        e &&
