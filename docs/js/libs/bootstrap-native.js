...
!(function (t, e) {
    ...
    var t = function (t, e) {
      ...
      o =
        new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(navigator.userAgent) !=
          null && parseFloat(RegExp.$1),
      n = function (t, e) {
        for (let o = e.charAt(0); t && t !== document; t = t.parentNode) {
      ...
      i =
        ...
        function (i, a) {
          (a = a || {}),
            (this.btn = typeof i === "object" ? i : document.querySelector(i)),
            (this.accordion = null),
            (this.collapse = null),
            (this.duration = 300),
            (this.options = {}),
          ...
          const r = this;
          const s = function (t) {
            const e = t && (t.currentStyle || window.getComputedStyle(t));
            const o = /px/.test(e.borderTopWidth)
              ? Math.round(e.borderTopWidth.replace("px", ""))
              : 0;
            const n = /px/.test(e.marginTop)
              ? Math.round(e.marginTop.replace("px", ""))
              : 0;
            const i = /px/.test(e.marginBottom)
              ? Math.round(e.marginBottom.replace("px", ""))
              : 0;
            const a = /em/.test(e.marginTop)
              ? Math.round(e.marginTop.replace("em", "") * parseInt(e.fontSize))
              : 0;
            const r = /em/.test(e.marginBottom)
              ? Math.round(
          ...
          (this.toggle = function (t) {
            ...
            (this.open = function () {
              if (
                ...
                const t = this.accordion.querySelectorAll(".collapse.in");
                const o = t.length;
                let n = 0;
            ...
            (this.getTarget = function () {
              const t = this.btn;
              const e = t.href && t.getAttribute("href").replace("#", "");
              const o =
                t.getAttribute("data-target") && t.getAttribute("data-target");
              const n = e || (o && /#/.test(o) && o.replace("#", ""));
              const i = o && o.charAt(0) === "." && o;
              return (
  ...
  for (
    var c = function (n, i) {
        (i = i || {}),
          (this.tab = typeof n === "object" ? n : document.querySelector(n)),
        ...
        (this.handle = function (o) {
          ...
          const r = a.getActiveTab();
          const s = a.getActiveContent();
          ...
          (this.getActiveTab = function () {
            const t = this.tabs.querySelectorAll(".active");
            return t.length !== 1 || /\bdropdown/.test(t[0].className)
              ? t.length > 1
                ? t[t.length - 1]
                : void 0
              : t[0];
